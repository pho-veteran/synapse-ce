...
# Java quality pack: javax -> jakarta namespace migration (Jakarta EE 9+), remaining specs.
RULES = [
    jakarta("transaction", "transaction", "Transactional"),
    jakarta("json", "json", "JsonObject"),
    jakarta("websocket", "websocket", "server.ServerEndpoint"),
    jakarta("el", "el", "ELProcessor"),
    jakarta("enterprise", "enterprise", "context.ApplicationScoped"),
]
